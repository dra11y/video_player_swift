...
class _SwiftVideoPlayerApiCodec extends StandardMessageCodec {
  const _SwiftVideoPlayerApiCodec();
  @override
...
class SwiftVideoPlayerApi {
  /// Constructor for [SwiftVideoPlayerApi].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  SwiftVideoPlayerApi({BinaryMessenger? binaryMessenger})
      : _binaryMessenger = binaryMessenger;
  final BinaryMessenger? _binaryMessenger;

  static const MessageCodec<Object?> codec = _SwiftVideoPlayerApiCodec();
